...
function findObjective(obj) {
	...
	//alert( "findObjective " + obj + " looks like " + objectiveLocation );
...
function setPrimaryObjToPassed(index) {
...
function setPrimaryObjToFailed(index) {
